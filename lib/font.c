...
/* Font 8x8 leggibile disegnato per PlexOS (pubblico dominio, creato ad-hoc).
   Bit 7 = pixel sinistro. */
static const u8 font8x8[128][8] = {
    [32] = {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // spazio
    ...
    [47] = {0x06,0x0C,0x18,0x30,0x60,0x40,0x00,0x00}, // /
    ...
    [51] = {0x7E,0x0C,0x18,0x0C,0x06,0x66,0x3C,0x00}, // 3
...
/* ritorna riga font (0-7) per carattere */
u8 font_row(char c, int row){
    if(row<0||row>7) return 0;
    return font8x8[(unsigned char)c & 0x7F][row];
}
